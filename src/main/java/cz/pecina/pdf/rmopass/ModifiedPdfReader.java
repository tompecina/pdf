 ...
 * @version 1.0.0
 */
public class ModifiedPdfReader extends PdfReader {

  // static logger
  private static final Logger log = Logger.getLogger(ModifiedPdfReader.class.getName());

  // for description see Object
  @Override
  public String toString() {
    return "ModifiedPdfReader";
  }
